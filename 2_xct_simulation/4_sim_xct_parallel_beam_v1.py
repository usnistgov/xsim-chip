...
imgs_out_dir = "./sim_radios_parallel_beam_pixsz4um/"

# Should not start with a slash. Do not include file extension here.
imgs_out_name = "radios_2400_chip_4um_parallel"
...
print("\nSetting up the parallel-beam x-ray source...")
gvxr.useParallelSource()

# [Source position x, position y, position z, "unit"]
gvxr.setSourcePosition(-30.0, 0, 0, "mm")

# # Perfectly monochromatic parallel beam for testing
# gvxr.setMonoChromatic(80.0, "keV", 1.0)

# Nearly monochromatic parallel beam
gvxr.addEnergyBinToSpectrum(80.0, "keV", 0.97) # The energy of 97% of the photons is 80 keV
gvxr.addEnergyBinToSpectrum(160.0, "keV", 0.02) # The energy of 2% of the photons is 160 keV
gvxr.addEnergyBinToSpectrum(240.0, "keV", 0.01) # The energy of 1% of the photons is 240 keV
...
gvxr.setDetectorPosition(30.0, 0, 0, "mm")
gvxr.setDetectorUpVector(0, 0, -1)
gvxr.setDetectorNumberOfPixels(1201, 1001)
gvxr.setDetectorPixelSize(0.004, 0.004, "mm")
...
pixel_size = detector_size / number_of_pixels
